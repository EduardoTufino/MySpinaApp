...
ActiveRecord::Schema.define(version: 20160425212736) do
  ...
  add_index "spina_line_translations", ["locale"], name: "index_spina_line_translations_on_locale"
  add_index "spina_line_translations", ["spina_line_id"], name: "index_spina_line_translations_on_spina_line_id"
  ...
  add_index "spina_page_translations", ["locale"], name: "index_spina_page_translations_on_locale"
  add_index "spina_page_translations", ["spina_page_id"], name: "index_spina_page_translations_on_spina_page_id"
  ...
  add_index "spina_text_translations", ["locale"], name: "index_spina_text_translations_on_locale"
  add_index "spina_text_translations", ["spina_text_id"], name: "index_spina_text_translations_on_spina_text_id"
